// JS halaman TAMBAH BERITA - bubble validasi browser berbahasa Indonesia. Jalan setelah HTML selesai dibaca.
document.addEventListener('DOMContentLoaded', () => {
  // Pesan wajib isi (ganti teks Inggris bawaan browser)
  const PESAN_WAJIB = { judul: 'Silahkan masukkan judul berita', konten: 'Silahkan tulis isi berita' };
