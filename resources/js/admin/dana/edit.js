// JS halaman UBAH DANA - validasi Indonesia + format rupiah bertitik. Jalan setelah HTML selesai dibaca.
document.addEventListener('DOMContentLoaded', () => {
  // Pesan wajib isi (ganti teks Inggris bawaan browser)
  const PESAN_WAJIB = {
    tahun: 'Silahkan isi tahun anggaran',
    sumber_dana: 'Silahkan pilih sumber dana',
  ...
  // Format nilai awal dari database agar langsung bertitik
